...
int main()
{
   ...
   // list<quadrangle> l;
       ...
       /*quadrangle q;
        cout << "input quadrangle " << endl;
        q.setPoint();
        cout << q.getPerimeter() << endl;
        cout << q.getSquare() << endl;
        if (q.isTrapezium())
            cout << "trapezium ok" << endl;
        if (q.isDiamond())
            cout << "Diamond" << endl;
        if (q.isParallelogram())
            cout << "Parallelogram" << endl;
        if (q.isRectangularQuadrangale())
            cout << "RectangularQuadrangale" << endl;
        if (q.isSquare())
            cout << "Square" << endl;
        */
   ...
   /* triangle t;
    ...
    if (t.isIsosceles())
        cout << "isIsosceles" << endl;
    if (t.isRectangular())
        cout << "isRectangular" << endl; */
